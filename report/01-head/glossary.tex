...
{
  name={Transformer},
  description={In \glsfirst{nlp}, a Transformer is a \glsfirst{seq2seq} architecture using the \glsfirst{attention}.}
}
...
\newacronym{gpt2}{GPT-2}{Generative Pre-Training 2}
